namespace ProjectsManagement.Authorization
{
    public static class PermissionNames
    {
        ...
        public const string Pages_ProjectsWorkers_EditProjectsWorkers = "Pages.ProjectsWorkers.EditProjectsWorkers";
        public const string Pages_ProjectsWorkers_DeleteProjectsWorkers = "Pages.ProjectsWorkers.DeleteProjectsWorkers";

        //ProjectsSupervisors (Show & CUD)
        ...
        public const string Pages_Jobs_CreateJob = "Pages.Jobs.CreateJob";
        public const string Pages_Jobs_EditJob = "Pages.Jobs.EditJob";
        public const string Pages_Jobs_DeleteJob = "Pages.Jobs.DeleteJob";


        //Sprints (Show & CUD)
        public const string Pages_Sprints = "Pages.Sprints";
        public const string Pages_Sprints_CreateSprints = "Pages.Sprints.CreateSprints";
