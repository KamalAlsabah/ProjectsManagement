...
{
    public abstract class ProjectsManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProjectsManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProjectsManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProjectsManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProjectsManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProjectsManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProjectsManagementDbContext, Task<T>> func)
        {
            T result;
